        ...
        <Box>
            ...
            <Container maxW='container.sm'>
                <VStack spacing={3}>
                    <Text color='gray.500' textAlign='justify'>
                        Coloque aqui a lista dos contatos com o nome, adicione uma vírgula e em
                        seguida adicione o número de telefone com o código do país (+55 para Brasil)
                        e o DDD. Você pode repetir esse processo em quantas linhas quiser.
                    </Text>
                    <Textarea
                        ...
                        ref={textRef}
                    />
                    <Button w='100%' isDisabled={buttonDisabled} onClick={handleSubmit}>
                        Gerar VCF
                    </Button>
                </VStack>
            </Container>
            ...
            >
                <Text color='gray.500' d='flex' alignItems='center' gap='8px'>
                    Ferramenta criada com <FaHeart color='red' display='inline-block' />
